...
def edit_item(request, pk):
    ...
    return render(request, 'bought/edit_item.html', {'form': form, 'item': item})
...
def delete_item(request, pk):
    ...
    if request.method == "POST":
        item.delete()
        return redirect('bought:index')
    return render(request, 'bought/confirm_delete.html', {'item': item})
...
def index(request):
    ...
    return render(request, 'bought/index.html', {'page_obj': page_obj})
...
def add_item(request):
    if request.method == 'POST':
        ...
        form = ItemForm()
    return render(request, 'bought/add.html', {'form': form})
