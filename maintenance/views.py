...
def edit_item(request, pk):
    ...
    return render(request, 'maintenance/edit_item.html', {'form': form, 'item': item})
...
def delete_item(request, pk):
    ...
    if request.method == "POST":
        item.delete()
        return redirect('maintenance:index')
    return render(request, 'maintenance/confirm_delete.html', {'item': item})
...
def index(request):
    ...
    return render(request, 'maintenance/index.html', {'page_obj': page_obj})
...
def add_item(request):
    if request.method == 'POST':
        ...
        form = ItemForm()
    return render(request, 'maintenance/add.html', {'form': form})
