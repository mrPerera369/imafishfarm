...
def edit_item(request, pk):
    ...
    return render(request, 'breeding/edit_item.html', {'form': form, 'item': item})
...
def index(request):
    ...
    return render(request, 'breeding/index.html', {'page_obj': page_obj})
